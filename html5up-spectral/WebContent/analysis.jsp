   ...
   <div id="page-wrapper">
      ...
      <div class="main">
         <input type="radio" id="tab-1" name="show" checked /> <input
            ...
            type="radio" id="tab-10" name="show" />

         <div class="tab">
            <label for="tab-1">NC 다이노스 </label>
            <label for="tab-2">두산 베어스</label>
            <label for="tab-3">KT 위즈</label>
            <label for="tab-4">LG 트윈스 </label> 
            <label for="tab-5">KIA 타이거즈</label>
            <label for="tab-6">롯데 자이언츠</label>
            <label for="tab-7">삼성 라이온즈</label>
            <label for="tab-8">SSG 랜더스</label> 
            <label for="tab-9">한화 이글스</label>
            <label for="tab-10">키움 히어로즈</label>
         </div>


         <div class="team_content">
            <div class="content-dis">
               <div class="NC teamresult">
            ...
            <div class="content-dis">
               <div class="DS">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, 두산 베어스는 섭씨 20 -
                        25도 일 때 승률이 높았으며 기온이 낮을 때(5-10) 성적이 저조한 것으로 보인다.</p>
            ...
            <div class="content-dis">
               <div class="KT">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, KT 위즈는 섭씨 20-25
                        일 때 승률이 높기도 했지만 성적이 가장 저조했던 것 으로 보인다.</p>
            ...
            <div class="content-dis">
               <div class="LG">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, LG 트윈스는 섭씨 25-30
                        도 일 때 좋은 성적을 보이며, 20 - 25도 일 때 저조한 성적을 보이는 것으로 알 수 있다.</p>
            ...
            <div class="content-dis">
               <div class="KIA">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, KIA 타이거즈는 섭씨
                        25-30도 일 때 좋은 성적을 보이며, 20 - 25도 일 때 저조한 성적을 보이는 것으로 알 수 있다.</p>
                  ...
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">
                        ...
                        추가적으로, 온도가 16~24℃ 이거나 25~34℃ 일 때 온도의 홈런 빈도수가 전반적으로 높았으며, <br>
                        반대로, 온도가 낮을 때 (0~15℃)는 홈런 빈도수가 다른 온도에 비해 낮게 기록됐고, <br> 온도가
                        높을 때(35~45℃)는 홈런 수가 거의 없음을 보여준다.
            ...
            <div class="content-dis">
               <div class="Lotte">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, 롯데 자이언츠는 섭씨
                        20-25도 일 때 좋은 성적을 보였지만, 저조한 성적을 보여 줬다는 것을 알 수 있습니다.</p>
            ...
            <div class="content-dis">
               <div class="SS">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, 섭씨 20-25도 일 때 가장
                        좋은 성적을 보였으며, 25-30도일 때 저조한 성적을 보였음을 알 수 있습니다.</p>
            ...
            <div class="content-dis">
               <div class="ssg">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, SSG 랜더스는 섭씨
                        20-25도 일때 성적이 저조하기도 했으며 우수한 성적을 거뒀음을 알 수 있습니다.</p>
                  ...
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">
                        ...
                        전반적으로 높았으며, <br> 반대로, 습도가 낮을 때 (0~20℃)는 홈런빈도 수가 다른 습도에 비해
                        낮게 기록됐다.
                     </p>
                  </figure>
            ...
            <div class="content-dis">
               <div class="HW">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, 한화 이글스는 섭씨
                        25-30일 때 성적이 가장 좋았으며, 20-25도 일 때 성적이 저조한 것을 알 수 있습니다.</p>
            ...
            <div class="content-dis">
               <div class="KW">
                  <figure class="highcharts-figure">
                     ...
                     <p class="highcharts-description">위 그래프를 통해, 키움 히어로즈는 섭씨 20-
                        25도 일 때 성적이 좋은 것을 알 수 있습니다</p>
