...
<body class="landing is-preload">
	...
	<div id="page-wrapper">
		...
		<!-- One -->
		<section id="UpdateSection" class="wrapper style1 special">
			...
			<div id="update">
				...
				<form action="UpdateServiceCon.do" method="post">
					...
					<input type="password" name="pw" value = "<%=dto.getPassword() %>" readonly>
					<input type="text" placeholder="Name" name="name" value = "<%=dto.getName() %>"> 
					<input type="text" placeholder="Age" name="age" value = "<%=dto.getAge() %>">
				  ...
				  <select name = "ft" id = "ft">
					...
					<button type="submit" value="login" class="button fit"> 확인</button>
