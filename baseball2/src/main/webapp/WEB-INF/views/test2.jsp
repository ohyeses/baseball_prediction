			...
			<div class="sec2">
				<div class="about show">
					...
					<div class=contact-form>
						<h2 style="font-size: 50px; color: #000; font-weight: bold;">게시물
							등록</h2>
						<form action="<c:url value='/boardInsert.do'/>" method="post">
							...
							<div class="input-wrap">
								<textarea id="message" name="contents" placeholder="내용"></textarea>
							</div>
							<div class="input-wrap"></div>
							<button type="submit" class="btn" onclick="goForm1()">등록</button>
						</form>
					</div>
				</div>
							...
							<div class="ani-wrap clearfix">
								...
								<div class="desc desc-right">
									...
									<p>
										...
										<br> <strong>stroke-dashoffset</strong>을 이용하여 각각의 <strong>stroke</strong>와
