...
<form action="<c:url value='/boardUpdate.do'/>" method="post">
	...
	<input type="hidden" name="count" value="${vo.cnt+1}"/> 
	...
	<thead>
		<tr>
			...
			<th class="tg-0pky"><input type="text" name="title" value=""/></th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td class="tg-c3ow">내용</td>
			<td class="tg-0pky"><textarea rows="5" cols="47" name="contents"> ${vo.content}</textarea></td>
		</tr>
		<tr>
